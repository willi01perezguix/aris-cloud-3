...
def main() -> None:
    parser = argparse.ArgumentParser(description="Create a POS sale (smoke)")
    ...
    print(f"Sale created: {response.header.id} status={response.header.status}")
