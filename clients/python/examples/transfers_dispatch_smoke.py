...
from aris3_client_sdk.transfer_validation import validate_dispatch_payload


def main() -> None:
    parser = argparse.ArgumentParser(description="ARIS3 transfers dispatch smoke CLI")
