...
from aris3_client_sdk.transfer_validation import validate_receive_payload
...
def _load_payload(path: str | None) -> dict:
    ...
    return {
        "receive_lines": [
            {"line_id": "line-id", "qty": 1, "location_code": "LOC-1", "pool": "P1", "location_is_vendible": True}
        ]
    }


def main() -> None:
    parser = argparse.ArgumentParser(description="ARIS3 transfers receive smoke CLI")
    ...
    try:
        ...
        validated = validate_receive_payload(payload)
